    ...
    <div class="w-full px-4 lg:px-8 flex items-center justify-between">
      ...
      <div class="hidden sm:block">
        <div class="flex items-center space-x-2 lg:space-x-4">
          <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-50 bg-blue-700 hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> HOME </a>
          <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-50 bg-blue-700 hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> TSO </a>
          <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-50 bg-blue-700 hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> JCL </a>
          <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-50 bg-blue-700 hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> COBOL </a>
          <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-50 bg-blue-700 hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> CICS </a>
          <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-50 bg-blue-700 hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> DB2 </a>
          <a href="#" class="whitespace-nowrap ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-50 bg-blue-700 hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> QUEM SOMOS </a>
        </div>
      </div>
...
<div class="max-w-4xl mx-auto">
  <div>
    ...
    <div class="mb-8 space-y-1.5">
      <div class="flex items-center space-x-4 h-14 bg-gray-300 px-3 py-2 rounded-md text-gray-800">
        <div class="text-sm">
          SEÇÃO 1
        </div> 
      ...
      <div class="px-3 py-2 flex items-center justify-between bg-gray-100 text-yellow-800">
    ...
    <div class="mb-8 space-y-1.5">
      ...
      {{-- <div class="h-full px-2 py-2 sm:px-3 flex flex-col sm:flex-row items-center bg-gray-100"> --}}
