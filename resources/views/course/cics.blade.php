      ...
      <div class="flex-grow"  >
        <div class="h-full"><!----> 
          <div class="yt-container h-full flex items-center justify-center sm:items-start sm:justify-start">
            <img class="object-cover -mt-1.5" src="https://s3.amazonaws.com/futureschool.com/_img/cics.png" alt="">
      ...
      <div class="flex flex-col w-full md:w-2/5">
        <div class="space-y-3">
          ...
          <div class="text-gray-600 space-y-3">
            <p>Neste curso você aprenderá <span class="inline-block">(na prática)</span> lógica de programação para construir programas pseudo conversacional em COBOL Online no ambiente CICS</p>
            <p>criando e utilizando arquivos VSAM, Menus, Mapas de tela, compilando e executando esses programas.</p>
