  ...
  <div class="w-full px-4 lg:px-8 flex items-center justify-between">
    ...
    <div class="hidden sm:block">
      <div class="flex items-center space-x-2 lg:space-x-4">
        ...
        <a href="{{route('register')}}" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-50 bg-yellow-500 hover:bg-blue-600 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> Cadastrar </a>
      </div>
    </div>
