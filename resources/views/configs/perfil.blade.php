...
<body class="">
  ...
  <div class="grid grid-cols-10 min-h-screen">
    <div class="col-span-3 bg-gray-200 pl-44 pt-12 pr-4">
      <ul>
        <li class="inline-flex items-center space-x-1 text-sm text-gray-600 dark:text-gray-400 font-medium group mb-2">
      ...
      <ul><li><a aria-current="page" href="/configuracoes/meu-perfil" class="router-link-active router-link-exact-active bg-gray-500 dark:bg-gray-700 text-gray-100 dark:text-gray-200 flex items-center w-full h-10 rounded-lg px-4"> Meu perfil </a></li><li><a href="/configuracoes/meus-cursos" class="text-gray-700 dark:text-gray-500 flex items-center w-full h-10 rounded-lg px-4"> Meus cursos </a></li><li><a href="/configuracoes/seguranca" class="text-gray-700 dark:text-gray-500 flex items-center w-full h-10 rounded-lg px-4"> Segurança </a></li></ul>
    </div>
