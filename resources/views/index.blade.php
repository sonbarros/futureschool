      ...
      <div class="container mx-auto space-y-10">
        <div>
          ...
          <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <!-- block -->
            <a href="/course/tso" class="flex flex-col bg-white rounded-md hover:shadow-xl border border-gray-300 overflow-hidden duration-300 ease-out transform hover:-translate-y-px">
              <div class="m-0">
